...
import { Recovered as RecoveredEvent } from "../generated/Router/Router"
import { handleRecovered } from "../src/router"
import { createRecoveredEvent } from "./router-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newRecoveredEvent = createRecoveredEvent(asset, amount)
